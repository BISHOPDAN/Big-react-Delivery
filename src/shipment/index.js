...
class index extends Component {
    render() {
        ...
        return ( <
            ...
            header className = "header-main" > { /* Header Topbar */ } <
            TopBar / > { /* /.Header Topbar */ } { /* Header Logo & Navigation */ } <
            MainNav / > { /* /.Header Logo & Navigation */ } <
            /header> { /* /.Header */ } { /* Content Wrapper */ } <
            CreateShipment / > { /* /.Content Wrapper */ } { /* Footer */ } <
            Footer / > { /* /.Footer */ } <
            /main> { /* / Main Wrapper */ } { /* Top */ } <
            div className = "to-top theme-clr-bg transition" > { " " } <
            i className = "fa fa-angle-up" / > { " " } <
            /div> { /* Popup: Login */ }

            { /* /Popup: Login */ } { /* Search Popup */ } <
